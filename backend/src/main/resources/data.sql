...
INSERT INTO tbl_movies (title, sub_title, year, img_url, synopsis, genre_id) VALUES ('Raya e o Último Dragão','A quest to save her world.',2021,'https://www.themoviedb.org/t/p/w533_and_h300_bestv2/hJuDvwzS0SPlsE6MNFOpznQltDZ.jpg','O reino encantado Kumandra é dividido em cinco regiões e sua população venerava os dragões mágicos que eram presentes no reino, porém quando uma força maligna ameaçou a Terra, os dragões se sacrificaram para salvar a humanidade. Agora, 500 anos depois, o mesmo mal voltou e cabe a uma guerreira solitária, Raya, rastrear o lendário último dragão para restaurar a terra fraturada e seu povo dividido.',2);
INSERT INTO tbl_movies (title, sub_title, year, img_url, synopsis, genre_id) VALUES ('Tom & Jerry - O Filme','Melhores inimigos. Piores amigos.',2021,'https://www.themoviedb.org/t/p/w533_and_h300_bestv2/cWlSnILiBXolR5vE1nHU2MzSxSp.jpg','Um gato de rua chamado Tom é contratado por uma garota chamada Kayla, uma jovem empregada que trabalha em um hotel glamouroso em Nova York, para se livrar de Jerry, um rato travesso que se mudou para o hotel, antes que ele seja a ruína de um importante casamento.',1);
INSERT INTO tbl_movies (title, sub_title, year, img_url, synopsis, genre_id) VALUES ('Monster Hunter','Junte-se à caçada.',2020,'https://www.themoviedb.org/t/p/w533_and_h300_bestv2/8tNX8s3j1O0eqilOQkuroRLyOZA.jpg','Baseado no jogo da Capcom chamado Monster Hunter, a tenente Artemis e seus soldados são transportados para um novo mundo. Lá, eles se envolvem em batalhas imponentes, buscando desesperadamente a sobrevivência contra bestas gigantes portadoras de habilidades surreais.',3);
INSERT INTO tbl_movies (title, sub_title, year, img_url, synopsis, genre_id) VALUES ('Liga da Justiça de Zack Snyder','Caído. Ressuscitado. Unidos.',2021,'https://www.themoviedb.org/t/p/w533_and_h300_bestv2/pcDc2WJAYGJTTvRSEIpRZwM3Ola.jpg','Determinado a garantir que o sacrifício final do Superman não foi em vão, Bruce Wayne alinha forças com Diana Prince com planos de recrutar uma equipe de metahumanos para proteger o mundo de uma ameaça de proporções catastróficas que se aproxima.',1);
INSERT INTO tbl_movies (title, sub_title, year, img_url, synopsis, genre_id) VALUES ('Um Príncipe em Nova York 2','Ele voltou como rei.',2021,'https://www.themoviedb.org/t/p/w533_and_h300_bestv2/vKzbIoHhk1z9DWYi8kyFe9Gg0HF.jpg','Situado no luxuoso país da realeza Zamunda, o recém coroado Rei Akeem e seu confidente Semmi embarcam em uma nova aventura que os levará ao redor do mundo: de sua grande nação Africana ao Queens, bairro de Nova York – onde tudo começou!',4);
INSERT INTO tbl_movies (title, sub_title, year, img_url, synopsis, genre_id) VALUES ('Mulher-Maravilha 1984','Uma nova era de maravilhas começa.',2020,'https://www.themoviedb.org/t/p/w533_and_h300_bestv2/egg7KFi18TSQc1s24RMmR9i2zO6.jpg','Em 1984, Diana Prince entra em conflito com dois inimigos formidáveis, Maxwell Lord e a Mulher-Leopardo, enquanto reencontra misteriosamente com seu antigo interesse amoroso Steve Trevor.',3);
INSERT INTO tbl_movies (title, sub_title, year, img_url, synopsis, genre_id) VALUES ('After - Depois da Verdade','Can love overcome the past?',2020,'https://www.themoviedb.org/t/p/w533_and_h300_bestv2/6hgItrYQEG33y0I7yP2SRl2ei4w.jpg','Após descobrir sobre a aposta, Tessa (Josephine Langford) tenta esquecer Hardin (Hero Fiennes Tiffin), o jovem caótico e revoltado que partiu seu coração. Porém, ela está prestes a descobrir que alguns amores não podem ser superados. Hardin sabe que cometeu o pior erro de sua vida ao ter magoado a jovem tão profundamente, mas vai lutar com toda a sua força para reconquistar o grande amor da sua vida.',5);
INSERT INTO tbl_movies (title, sub_title, year, img_url, synopsis, genre_id) VALUES ('Skylines','To save our world she must invade theirs.',2020,'https://www.themoviedb.org/t/p/w533_and_h300_bestv2/3ombg55JQiIpoPnXYb2oYdr6DtP.jpg','Quando um vírus ameaça transformar os híbridos alienígenas amigáveis que agora vivem na Terra contra os humanos, a capitã Rose Corley deve liderar uma equipe de mercenários de elite em uma missão ao mundo alienígena para salvar o que resta da humanidade.',6);
INSERT INTO tbl_movies (title, sub_title, year, img_url, synopsis, genre_id) VALUES ('Agentes Vanguard',null,2020,'https://www.themoviedb.org/t/p/w533_and_h300_bestv2/4TGqXMsy9qM2nAUq4rYrErjkMXL.jpg','A empresa de segurança secreta Vanguard é a última esperança de sobrevivência para um contador, depois que ele é alvo da organização mercenária mais mortal do mundo.',1);
INSERT INTO tbl_movies (title, sub_title, year, img_url, synopsis, genre_id) VALUES ('Godzilla vs. Kong','Um dos dois cairá.',2021,'https://www.themoviedb.org/t/p/w533_and_h300_bestv2/iopYFB1b6Bh7FWZh3onQhph1sih.jpg','Em uma época em que os monstros andam na Terra, a luta da humanidade por seu futuro coloca Godzilla e Kong em rota de colisão que verá as duas forças mais poderosas da natureza no planeta se confrontarem em uma batalha espetacular para as idades. Enquanto Monarch embarca em uma missão perigosa em terreno desconhecido e descobre pistas sobre as origens dos Titãs, uma conspiração humana ameaça tirar as criaturas, boas e más, da face da terra para sempre.',6);
